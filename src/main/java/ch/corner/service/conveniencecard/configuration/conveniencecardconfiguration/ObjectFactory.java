...
public class ObjectFactory {
    ...
    private final static QName _GetNationListRequest_QNAME = new QName("http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", "getNationListRequest");
    private final static QName _GetNapAndCityListRequest_QNAME = new QName("http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", "getNapAndCityListRequest");
    private final static QName _GetDecodedPF20Request_QNAME = new QName("http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", "getDecodedPF20Request");
    private final static QName _GetParamInfoRequest_QNAME = new QName("http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", "getParamInfoRequest");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", name = "getNationListRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", name = "getNapAndCityListRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", name = "getDecodedPF20Request")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://configuration.conveniencecard.service.corner.ch/convenienceCardConfiguration", name = "getParamInfoRequest")
